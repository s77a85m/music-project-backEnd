    ...
    <div x-data="newArtist" class="flex container relative p-7 flex-col gap-2 items-end">
        ...
        <div x-show="open" x-cloak
            ...
            <form dir="rtl" action="#" class="w-full flex relative flex-col gap-2 justify-center items-center ">
                <!-- name -->
                <input type="text" placeholder="نام آلبوم" class="w-full md:w-1/3 h-8 border border-gray-300 focus:ring-0 focus:border-gray-300 text-xs font-normal  text-gray-500 rounded-lg">
                <!-- artist -->
