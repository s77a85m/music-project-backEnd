    ...
    <div x-data="newArtist" class="flex container relative p-7 flex-col gap-2 items-end">
        ...
        <div x-show="open" x-cloak
            ...
            <form dir="rtl" action="#" class="w-full flex relative flex-col gap-2 justify-center items-center ">
                ...
                <!-- artist -->
                <select name="style" id="style" class=" w-full md:w-1/3 h-8 border border-gray-300 focus:ring-0 focus:border-gray-300 text-xs font-normal  text-gray-500 rounded-lg">
                    <option disabled selected value="1">خواننده</option>
                    <option value="1">محدي احمدوند</option>
                    <option value="2">مهدي جهاني</option>
                    <option value="3">علي لهراسبي</option>
                    <option value="4">همايون شحريان</option>
                </select>
                <!-- album -->
                <select name="style" id="style" class=" w-full md:w-1/3 h-8 border border-gray-300 focus:ring-0 focus:border-gray-300 text-xs font-normal  text-gray-500 rounded-lg">
                    <option disabled selected value="1">آلبوم</option>
                    <option value="1">دريا</option>
                    <option value="2">عشق</option>
                    <option value="3">بهشت</option>
                    <option value="4">دنياي فاني</option>
                </select>
                <!-- text -->
                <textarea name="description" id="" class="resize-none w-full md:w-2/3 text-xs font-medium text-gray-500 rounded-md h-40 border border-gray-200 focus:ring-0 focus:border-gray-200" placeholder="متن آهنگ"></textarea>
                <!-- img -->
        ...
        <div class="w-full bg-white py-2  flex flex-col gap-4 shadow-lg h-auto">
            <table dir="rtl" class="w-full px-3 h-auto bg-white rounded-lg  border-collapse ">
                ...
                <tr class="text-xs odd:bg-white even:bg-gray-100">
                    ...
                    <td class="p-2">
                        <div class="h-8 w-8 rounded-full overflow-hidden">
                            <img src="/image/slider1.jpg" alt="avatar" class="w-full h-full">
                        </div>
                    </td>
                    <td class="p-2  ">شق اول</td>
                    <td class="p-2  ">مهدي احمدوند</td>
                ...
                <tr class="text-xs odd:bg-white even:bg-gray-100">
                    ...
                    <td class="p-2">
                        <div class="h-8 w-8 rounded-full overflow-hidden">
                            <img src="/image/slider2.jpg" alt="avatar" class="w-full h-full">
                        </div>
                    </td>
                    <td class="p-2  ">دريا</td>
                    <td class="p-2  ">مهدي جهاني</td>
                    <td class="p-2 flex gap-2">
                        <a href="#" title="حذف"
                           class="h-6 w-auto px-2 flex flex-center text-white bg-red-500 rounded-sm ">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20"
                ...
                <tr class="text-xs odd:bg-white even:bg-gray-100">
                    ...
                    <td class="p-2">
                        <div class="h-8 w-8 rounded-full overflow-hidden">
                            <img src="/image/slider3.jpg" alt="avatar" class="w-full h-full">
                        </div>
                    </td>
                    <td class="p-2  ">آرامش</td>
                    <td class="p-2  ">سيد علي موسوي</td>
                    <td class="p-2 flex gap-2">
                        <a href="#" title="حذف"
                           class="h-6 w-auto px-2 flex flex-center text-white bg-red-500 rounded-sm ">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20"
